...
### setup_requires dependencies
  ...
  test do
    ...
    # Ensure Ansible uses the virtualenv when doing local commands.
    (testpath/"import_shade.py").write <<-EOF.undent
      #!/usr/bin/python
      # coding: utf-8 -*-
      import json
      import shade
      ...
      def main():
        ...
        module.exit_json(changed=False, msg="Successfully imported shade")

      from ansible.module_utils.basic import AnsibleModule
      if __name__ == '__main__':
        main()
    EOF
    system bin/"ansible", "-M", testpath, "-i", "localhost,", "-c", "local", "-m", "import_shade", "localhost"
  end
end
